System.define(
	"MultiTheftAuto.Shared",
	{
		GetBlipSize = getBlipSize,
		GetBlipColor = function(...)
			return System.tuple(getBlipColor(...))
		end,
		...
		GetClothesByTypeIndex = function(...)
			return System.tuple(getClothesByTypeIndex(...))
		end,
		GetClothesTypeName = getClothesTypeName,
		CreateColCuboid = createColCuboid,
		CreateColCircle = createColCircle,
		GetTypeIndexFromClothes = function(...)
			return System.tuple(getTypeIndexFromClothes(...))
		end,
		...
		GetElementAttachedOffsets = function(...)
			return System.tuple(getElementAttachedOffsets(...))
		end,
		...
		GetElementRotation = function(...)
			return System.tuple(getElementRotation(...))
		end,
		GetElementID = getElementID,
		GetElementModel = getElementModel,
		GetElementVelocity = function(...)
			return System.tuple(getElementVelocity(...))
		end,
		GetLowLODElement = getLowLODElement,
		GetRootElement = getRootElement,
		GetElementPosition = function(...)
			return System.tuple(getElementPosition(...))
		end,
		...
		AddEventHandler = function(event, src, handlerName, delegate, priorty)
		...
		GetMarkerColor = function(...)
			return System.tuple(getMarkerColor(...))
		end,
		...
		GetObjectScale = function(...)
			return System.tuple(getObjectScale(...))
		end,
		...
		GetMarkerTarget = function(...)
			return System.tuple(getMarkerTarget(...))
		end,
		...
		GetPedClothes = function(...)
			return System.tuple(getPedClothes(...))
		end,
		...
		GetPlayerNametagColor = function(...)
			return System.tuple(getPlayerNametagColor(...))
		end,
		...
		GetRadarAreaColor = function(...)
			return System.tuple(getRadarAreaColor(...))
		end,
		CreateRadarArea = createRadarArea,
		GetRadarAreaSize = function(...)
			return System.tuple(getRadarAreaSize(...))
		end,
		...
		GetTeamColor = function(...)
			return System.tuple(getTeamColor(...))
		end,
		...
		GetColorFromString = function(...)
			return System.tuple(getColorFromString(...))
		end,
		...
		GetPerformanceStats = function(...)
			return System.tuple(getPerformanceStats(...))
		end,
		GetRealTime = getRealTime,
		GetTimerDetails = function(...)
			return System.tuple(getTimerDetails(...))
		end,
		GetTimers = getTimers,
		...
		Hash = hash,
		Iprint = iprint,
		InterpolateBetween = function(...)
			return System.tuple(interpolateBetween(...))
		end,
		...
		Utf8_widthindex = function(...)
			return System.tuple(utf8.widthindex(...))
		end,
		...
		GetVehicleColor = function(...)
			return System.tuple(getVehicleColor(...))
		end,
		...
		GetVehicleHeadLightColor = function(...)
			return System.tuple(getVehicleHeadLightColor(...))
		end,
		...
		GetVehicleTurretPosition = function(...)
			return System.tuple(getVehicleTurretPosition(...))
		end,
		...
		GetVehicleVariant = function(...)
			return System.tuple(getVehicleVariant(...))
		end,
		GetVehicleWheelStates = function(...)
			return System.tuple(getVehicleWheelStates(...))
		end,
		...
		Utf8_charpos = function(...)
			return System.tuple(utf8.charpos(...))
		end,
		Utf8_char = utf8.char,
		...
		GetWaterColor = function(...)
			return System.tuple(getWaterColor(...))
		end,
		...
		GetWaterVertexPosition = function(...)
			return System.tuple(getWaterVertexPosition(...))
		end,
		...
		GetSunColor = function(...)
			return System.tuple(getSunColor(...))
		end,
		GetSunSize = getSunSize,
		GetSkyGradient = function(...)
			return System.tuple(getSkyGradient(...))
		end,
		GetTime = function(...)
			return System.tuple(getTime(...))
		end,
		GetTrafficLightState = getTrafficLightState,
		GetZoneName = getZoneName,
		GetWeather = function(...)
			return System.tuple(getWeather(...))
		end,
		IsGarageOpen = isGarageOpen,
		GetWindVelocity = function(...)
			return System.tuple(getWindVelocity(...))
		end,
