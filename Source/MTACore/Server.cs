...
namespace MultiTheftAuto {
	public class Server {
		...
		public static bool LogIn (MTAElement thePlayer, Account theAccount, string thePassword){ throw new NotImplementedException(); }
		public static bool LogOut (MTAElement thePlayer){ throw new NotImplementedException(); }
		public static bool SetAccountPassword (Account theAccount, string password){ throw new NotImplementedException(); }
		public static Account GetAccountByID (int id){ throw new NotImplementedException(); }
		public static int GetAccountID (Account theAccount){ throw new NotImplementedException(); }
		public static dynamic GetAccountsByData (string dataName, string value){ throw new NotImplementedException(); }
		public static bool RemoveAccount (Account theAccount){ throw new NotImplementedException(); }
		public static Account GetPlayerAccount (MTAElement thePlayer){ throw new NotImplementedException(); }
		public static bool SetAccountData (Account theAccount, string key, string value){ throw new NotImplementedException(); }
		public static dynamic GetAllAccountData (Account theAccount){ throw new NotImplementedException(); }
		public static bool IsGuestAccount (Account theAccount){ throw new NotImplementedException(); }
		public static dynamic GetAccountsBySerial (string serial){ throw new NotImplementedException(); }
		public static string GetAccountSerial (Account theAccount){ throw new NotImplementedException(); }
		public static string GetAccountData (Account theAccount, string key){ throw new NotImplementedException(); }
		public static Account GetAccount (string username, string password, bool caseSensitive){ throw new NotImplementedException(); }
		public static string GetAccountName (Account theAccount){ throw new NotImplementedException(); }
		public static MTAElement GetAccountPlayer (Account theAccount){ throw new NotImplementedException(); }
		public static bool CopyAccountData (Account theAccount, Account fromAccount){ throw new NotImplementedException(); }
		public static Account AddAccount (string name, string pass, bool allowCaseVariations){ throw new NotImplementedException(); }
		public static Acl AclCreate (string aclName){ throw new NotImplementedException(); }
		public static string GetAccountIP (Account theAccount){ throw new NotImplementedException(); }
		public static dynamic GetAccountsByIP (string ip){ throw new NotImplementedException(); }
		public static bool SetAccountName (Account theAccount, string name, bool allowCaseVariations){ throw new NotImplementedException(); }
		public static string AclGetName (Acl theAcl){ throw new NotImplementedException(); }
		public static bool AclDestroy (Acl theACL){ throw new NotImplementedException(); }
		public static AclGroup AclCreateGroup (string groupName){ throw new NotImplementedException(); }
		public static AclGroup AclGetGroup (string groupName){ throw new NotImplementedException(); }
		public static Acl AclGet (string aclName){ throw new NotImplementedException(); }
		public static bool AclGroupAddObject (AclGroup theGroup, string theObjectName){ throw new NotImplementedException(); }
		public static bool AclDestroyGroup (AclGroup aclGroup){ throw new NotImplementedException(); }
		public static dynamic AclGroupList (){ throw new NotImplementedException(); }
		public static dynamic AclGroupListACL (AclGroup theGroup){ throw new NotImplementedException(); }
		public static bool AclGetRight (Acl theAcl, string rightName){ throw new NotImplementedException(); }
		public static bool AclGroupAddACL (AclGroup theGroup, Acl theACL){ throw new NotImplementedException(); }
		public static string AclGroupGetName (AclGroup aclGroup){ throw new NotImplementedException(); }
		public static dynamic AclGroupListObjects (AclGroup theGroup){ throw new NotImplementedException(); }
		public static bool AclGroupRemoveACL (AclGroup theGroup, Acl theACL){ throw new NotImplementedException(); }
		public static dynamic AclList (){ throw new NotImplementedException(); }
		public static bool AclGroupRemoveObject (AclGroup theGroup, string theObjectString){ throw new NotImplementedException(); }
		public static dynamic AclListRights (Acl theACL, string allowedType){ throw new NotImplementedException(); }
		public static bool AclSetRight (Acl theAcl, string rightName, bool hasAccess){ throw new NotImplementedException(); }
		public static bool AclReload (){ throw new NotImplementedException(); }
		public static bool AclRemoveRight (Acl theAcl, string rightName){ throw new NotImplementedException(); }
		...
		public static bool IsObjectInACLGroup (string theObject, AclGroup theGroup){ throw new NotImplementedException(); }
		public static Ban AddBan (string IP, string Username, string Serial, MTAElement responsibleElement, string reason, int seconds){ throw new NotImplementedException(); }
		public static string GetBanAdmin (Ban theBan){ throw new NotImplementedException(); }
		public static Ban BanPlayer (MTAElement bannedPlayer, bool IP, bool Username, bool Serial, dynamic responsiblePlayer, string reason, int seconds){ throw new NotImplementedException(); }
		public static string GetBanNick (Ban theBan){ throw new NotImplementedException(); }
		public static string GetBanIP (Ban theBan){ throw new NotImplementedException(); }
		public static string GetBanReason (Ban theBan){ throw new NotImplementedException(); }
		public static int GetBanTime (Ban theBan){ throw new NotImplementedException(); }
		public static string GetBanSerial (Ban theBan){ throw new NotImplementedException(); }
		public static string GetBanUsername (Ban theBan){ throw new NotImplementedException(); }
		public static dynamic GetBans (){ throw new NotImplementedException(); }
		public static bool SetBanAdmin (Ban theBan, string theAdmin){ throw new NotImplementedException(); }
		...
		public static int GetUnbanTime (Ban theBan){ throw new NotImplementedException(); }
		public static bool IsBan (Ban theBan){ throw new NotImplementedException(); }
		public static bool SetUnbanTime (Ban theBan, int theTime){ throw new NotImplementedException(); }
		...
		public static bool RemoveBan (Ban theBan, MTAElement responsibleElement){ throw new NotImplementedException(); }
		public static bool SetBanNick (Ban theBan, string theNick){ throw new NotImplementedException(); }
		public static string GetMapName (){ throw new NotImplementedException(); }
		public static bool SetBanReason (Ban theBan, string theReason){ throw new NotImplementedException(); }
		...
		public static Resource CopyResource (Resource theResource, string newResourceName, string organizationalDir){ throw new NotImplementedException(); }
		...
		public static Resource CreateResource (string resourceName, string organizationalDir){ throw new NotImplementedException(); }
		public static dynamic GetResourceACLRequests (Resource theResource){ throw new NotImplementedException(); }
		public static int GetResourceLastStartTime (Resource theResource){ throw new NotImplementedException(); }
		public static MTAElement GetResourceMapRootElement (Resource theResource, string mapName){ throw new NotImplementedException(); }
		public static string GetResourceLoadFailureReason (Resource theResource){ throw new NotImplementedException(); }
		public static int GetResourceLoadTime (Resource res){ throw new NotImplementedException(); }
		public static string GetResourceOrganizationalPath (Resource theResource){ throw new NotImplementedException(); }
		public static string GetResourceInfo (Resource theResource, string attribute){ throw new NotImplementedException(); }
		public static dynamic GetResources (){ throw new NotImplementedException(); }
		public static bool IsResourceArchived (Resource resourceElement){ throw new NotImplementedException(); }
		public static bool RefreshResources (bool refreshAll, Resource targetResource){ throw new NotImplementedException(); }
		public static bool RemoveResourceFile (Resource theResource, string fileName){ throw new NotImplementedException(); }
		...
		public static bool RestartResource (Resource theResource, bool persistent, bool configs, bool maps, bool scripts, bool html, bool clientConfigs, bool clientScripts, bool clientFiles){ throw new NotImplementedException(); }
		public static bool SetResourceInfo (Resource theResource, string attribute, string value){ throw new NotImplementedException(); }
		public static bool UpdateResourceACLRequest (Resource theResource, string rightName, bool access, string byWho){ throw new NotImplementedException(); }
		public static bool StopResource (Resource theResource){ throw new NotImplementedException(); }
		public static bool StartResource (Resource resourceToStart, bool persistent, bool startIncludedResources, bool loadServerConfigs, bool loadMaps, bool loadServerScripts, bool loadHTML, bool loadClientConfigs, bool loadClientScripts, bool loadFiles){ throw new NotImplementedException(); }
