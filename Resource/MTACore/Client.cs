...
namespace MultiTheftAuto {
	public class Client {
		...
		public static bool TriggerServerEvent (string argument_event, MTAElement theElement){ throw new NotImplementedException(); }
		...
		public static MTAElement GetResourceGUIElement (MTAElement theResource){ throw new NotImplementedException(); }
