...
namespace MultiTheftAuto {
	public class Server {
		...
		public static bool AddEventHandler (string eventName, Element attachedTo, string handlerFunction, bool getPropagated, string priority){ throw new NotImplementedException(); }
