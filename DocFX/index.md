  ...
  <div class="wrap">
    ...
    <div class="col-lg-4 col-sm-6 col-sm-12 col-xs-12">
      ...
      <div class="buttons-unit">
          <a href="tutorial/gettingStarted.md" class="button b-1"><i class="glyphicon glyphicon-chevron-right"></i>Getting Started</a>
...
<div class="container">
  <div class="wrap row main-info">
      ...
      <div class="col-md-4 col-md-offset-0 col-xs-offset-1 col-xs-10">
        <h3>Slipe-Core</h3>
        <p>
          Take advantage of C#! The framework enables you to write scripts for MTA:San Andreas in C# instead of Lua, wrapping all MTA elements and classes. It also includes some .NET Core namespaces.
        </p>
        <p>
