...
namespace SlipeLua.MtaDefinitions {
    public class MtaClient
    {
        ...
        public static bool DxDrawImage(float posX, float posY, float width, float height, dynamic image, float rotation, float rotationCenterOffsetX, float rotationCenterOffsetY, int color, bool postGui) { throw new NotImplementedException(); }
        ...
        public static bool DxDrawMaterialPrimitive(dynamic pType, dynamic material, bool postGUI, dynamic amount, dynamic vectors, dynamic colors, dynamic topLefts) { throw new NotImplementedException(); }
        ...
        public static bool DxDrawPrimitive(string pType, bool postGUI, dynamic amount, dynamic vectors, dynamic colors) { throw new NotImplementedException(); }
        ...
        public static Tuple<float, float, float> GetVehicleComponentScale(MtaElement theVehicle, string theComponent, string theBase) { throw new NotImplementedException(); }
        public static bool SetVehicleComponentScale(MtaElement theVehicle, string theComponent, float x, float y, float z, string theBase) { throw new NotImplementedException(); }
        public static bool ResetVehicleComponentScale(MtaElement theVehicle, string theComponent) { throw new NotImplementedException(); }
        public static int GuiGridListGetSelectionMode(MtaElement gridList) { throw new NotImplementedException(); }
        public static bool GuiGridListIsSortingEnabled(MtaElement gridList) { throw new NotImplementedException(); }
        public static Tuple<float, float, float> GetVehicleModelDummyPosition(int vehicleModel, string dummy) { throw new NotImplementedException(); }
        public static bool SetVehicleModelDummyPosition(int vehicleModel, string dummy, float x, float y, float z) { throw new NotImplementedException(); }
        public static string GetKeyboardReadingLayout() { throw new NotImplementedException(); }
