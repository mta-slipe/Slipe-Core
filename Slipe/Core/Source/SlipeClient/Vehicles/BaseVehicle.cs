...
{
    /// <summary>
    /// Base class for all client vehicles
    /// </summary>
    public class BaseVehicle : SharedVehicle
    {
        ...
        /// </summary>
        public BaseVehicle(BaseVehicleModel model, Vector3 position) : base(model, position)
        {
        ...
        /// </summary>
        public BaseVehicle(BaseVehicleModel model, Vector3 position, Vector3 rotation, string numberplate = "", int variant1 = 1, int variant2 = 1) : base(model, position, rotation, numberplate, variant1, variant2)
        {
        }
        #endregion
