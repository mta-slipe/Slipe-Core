...
namespace Slipe.Client.Dx
{
    ...
    /// </summary>
    public class DxCircle : Dx2DObject, IDrawable
    {
        /// <summary>
        ...
        /// Create a circle
        /// </summary>
        public DxCircle(Vector2 position, float radius, Color color, Color centerColor, float startAngle = 0.0f, float stopAngle = 360.0f, int segments = 32, int ratio = 1, bool postGUI = false)
        {
            Position = position;
            Radius = radius;
            Color = color;
        ...
        /// </summary>
        public DxCircle(Vector2 position, float radius, Color color) : this(position, radius, color, color) { }

        /// <summary>
        /// Creates a white circle
        /// </summary>
        public DxCircle(Vector2 position, float radius) : this(position, radius, Color.White) { }
