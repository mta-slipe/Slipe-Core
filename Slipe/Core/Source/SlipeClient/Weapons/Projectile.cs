...
namespace Slipe.Client.Weapons
{
    ...
    public class Projectile : PhysicalElement
    {
        ...
        {
            element = MtaClient.CreateProjectile(creator.MTAElement, (int)projectile, startPos.X, startPos.Y, startPos.Z, force, target.MTAElement, rotation.X, rotation.Y, rotation.Z, velocity.X, velocity.Y, velocity.Z, -1);
        ...
        /// </summary>
        public Projectile(Player creator, ProjectileType projectile, Vector3 startPos, float force, PhysicalElement target, Vector3 rotation) : this(creator, projectile, startPos, force, target, rotation, Vector3.Zero) { }

        /// <summary>
        /// Create a new projectile
        /// </summary>
        public Projectile(Player creator, ProjectileType projectile, Vector3 startPos, float force, PhysicalElement target) : this(creator, projectile, startPos, force, target, Vector3.Zero) { }

        /// <summary>
        /// Create a new projectile
        /// </summary>
        public Projectile(Player creator, ProjectileType projectile, Vector3 startPos, float force = 1.0f) : this(creator, projectile, startPos, force, null) { }
