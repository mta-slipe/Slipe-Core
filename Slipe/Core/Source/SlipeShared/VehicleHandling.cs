...
namespace Slipe.Shared
{
    ...
    public class VehicleHandling
    {
        ...
        protected void BuildFromTable(Dictionary<string, dynamic> t)
        {
            ...
            percentSubmerged = t["percentSubmerged"];
            tractionMultiplier = t["tractionMultiplier"];
            tractionLoss = t["tractionLoss"];
            tractionBias = t["tractionBias"];
            numberOfGears = t["numberOfGears"];
            maxVelocity = t["maxVelocity"];
            engineAcceleration = t["engineAcceleration"];
            engineInertia = t["engineInertia"];
            ...
            brakeDeceleration = t["brakeDeceleration"];
            brakeBias = t["brakeBias"];
            steeringLock = t["steeringLock"];
            suspensionForceLevel = t["suspensionForceLevel"];
            suspensionDamping = t["suspensionDamping"];
            suspensionHighSpeedDamping = t["suspensionHighSpeedDamping"];
            suspensionUpperLimit = t["suspensionUpperLimit"];
            suspensionLowerLimit = t["suspensionLowerLimit"];
            suspensionFrontRearBias = t["suspensionFrontRearBias"];
            suspensionAntiDiveMultiplier = t["suspensionAntiDiveMultiplier"];
            seatOffsetDistance = t["seatOffsetDistance"];
            collisionDamageMultiplier = t["collisionDamageMultiplier"];
            monetary = t["monetary"];
