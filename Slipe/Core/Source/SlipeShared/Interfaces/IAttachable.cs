...
namespace Slipe.Shared.Interfaces
{
    ...
    public interface IAttachable
    {
        ...
        /// </summary>
        void AttachTo(IToAttachable toElement, Matrix4x4 offsetMatrix);

        /// <summary>
        /// Attach this attachable to a toAttachable with 2 vectors describing a position offset and a rotation offset
        /// </summary>
        void AttachTo(IToAttachable toElement, Vector3 positionOffset, Vector3 rotationOffset);
        ...
        /// </summary>
        void AttachTo(IToAttachable toElement, Vector3 positionOffset, Quaternion rotationOffset);

        /// <summary>
        /// Attach this attachable to a toAttachable without any offset
        /// </summary>
        void AttachTo(IToAttachable toElement);
