...
namespace Slipe.Server
{
    ...
    public class Marker : SharedMarker 
    {
        ...
        /// </summary>
        public Marker(Vector3 position, MarkerTypeEnum type, Color color, float size = 4.0f, Element visibleTo = null)
        {
        ...
        /// </summary>
        public Marker(Vector3 position, MarkerTypeEnum type) : this (position, type, Color.Red) { }
    }
}
