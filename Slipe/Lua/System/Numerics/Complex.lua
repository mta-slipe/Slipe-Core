...
Complex.GetHashCode = function (this)
    local n1 = 99999997
    local hash_real = bitXor(this.m_real:GetHashCode(), n1)
    local hash_imaginary = this.m_imaginary:GetHashCode()
    local final_hashcode = hash_real * bitNot(hash_imaginary)
